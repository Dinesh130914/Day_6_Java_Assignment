...
public class Vendingmachine {
	public static void main(String[] args) {
     ...
     static int thousandCount = 0, fiveHundredCount = 0, hundredCount = 0, fiftyCount = 0, tenCount = 0, fiveCount = 0, twoCount = 0, oneCount = 0;
     static int minimumNotes(int withdrawAmount) {
        if (withdrawAmount > 0) {
